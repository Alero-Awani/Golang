...
func (o Odumodu) sing() string {
	return fmt.Sprintf("My name is %s and i sing about Cultism and nacks", o.name)
}
...
func (b Burna) sing() string {
  return fmt.Sprintf("My name is %s and I sing Sensible music ", b.name)
}

func concert(s singer) {
	fmt.Printf("Welcome to FlytimeFest!, %s \n", s.sing())
}

func main(){
	o := Odumodu{name: "Odumodu"}
	b := Burna{name: "Burna"}
